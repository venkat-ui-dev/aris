        ...
        <div className="flex flex-col items-center mt-16 space-y-4">
            ...
            <div className="flex justify-around w-full max-w-md space-x-12">
                ...
                <button
                    ...
                    className={`w-16 h-16 flex justify-center items-center rounded-full text-white hover:bg-blue-300 ${isMuted ? 'bg-red-500' : 'bg-blue-400'}`}>
                    {isMuted ? (
                ...
                <button
                    ...
                    className={`w-16 h-16 flex justify-center items-center rounded-full ${isSpeaking ? 'bg-green-500 text-white hover:bg-green-600' : 'bg-blue-400 text-white hover:bg-green-600'}`}
                >
                    <MicrophoneIcon className="w-8 h-8" />
                </button>

                {/* Documentation Icon */}
                <button className="w-16 h-16 flex justify-center items-center bg-blue-400 rounded-full text-white hover:bg-blue-300">
